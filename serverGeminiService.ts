...
4. WEAVE THESE EXACT DETAILS explicitly into your generated visual prompt. MANDATE COMPLETE DESCRIPTIONS: If the JSON describes a machine, ship, place, equipment, or structure, you are STRICTLY FORCED to put that exact descriptive structure and its components directly into the prompt. 
...
CRITICAL DIAGNOSTIC RULES FOR PROMPT GENERATION (MANDATORY VALIDATION RULES):
...
PROMPT LENGTH LIMIT: You may write robust and highly detailed prompts up to 300 words to ensure all rules, descriptive structures, and exact details from the Manufacturing JSON are comprehensively captured.
