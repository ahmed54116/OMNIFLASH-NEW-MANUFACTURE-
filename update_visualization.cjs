...
// Insert it before OUTPUT RULES in generateSingleClip
code = code.replace(/OUTPUT RULES:/g, documentaryVisualization + '\n\nOUTPUT RULES:');

fs.writeFileSync('services/geminiService.ts', code);
console.log("Updated documentary visualization");
