...
const regex = /const continuityContext = \(typeof settings !== 'undefined' && settings\.continuityJson \? settings\.continuityJson : null\)\s*\?[^;]+;\s*const continuityContext = \(typeof settings !== 'undefined' && settings\.continuityJson \? settings\.continuityJson : null\)\s*\?[^;]+;/;

code = code.replace(regex, `const continuityContext = (typeof settings !== 'undefined' && settings.continuityJson ? settings.continuityJson : null)
...
console.log("Fixed duplicate continuityContext");
